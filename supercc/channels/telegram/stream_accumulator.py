"""Telegram StreamAccumulator — buffers streaming text chunks and flushes to Telegram in batches.

Telegram message updates are expensive (one API call per message), so we buffer
...
class StreamAccumulator:
    ...
    def __init__(self, chat_id: str, message_id: str, send_fn: Callable[[str, str, str], Awaitable[None]], flush_timeout: float = 1.5):
